...
contract MoodNftIntegrationTest is Test {
    ...
    string public constant basUri = "data:application/json;base64,";
    ...
    function testFlipTokenToTest() public {
        vm.prank(USER);
        moodNft.mintNFT();

        assertEq(
            keccak256(abi.encodePacked(moodNft.tokenURI(0))),
            keccak256(abi.encodePacked(happySVGUri))
        );
        ...
        assertEq(
            keccak256(abi.encodePacked(moodNft.tokenURI(0))),
            keccak256(abi.encodePacked(sadSVGUri))
        );
    }
}
